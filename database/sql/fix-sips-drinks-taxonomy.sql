...
-- Deactivate renamed/removed divisions under valid subs (92 official pairs)
UPDATE public.recipe_divisions SET is_active = false
WHERE category = 'Sips & Stories'
  AND (subcategory, name) NOT IN (
    ('Water & Sparkling', 'Still & Mineral Water'), ('Water & Sparkling', 'Sparkling Water'), ('Water & Sparkling', 'Infused & Fruit Waters'), ('Water & Sparkling', 'Flavoured & Vitamin Waters'), ('Water & Sparkling', 'Spa & Detox Waters'), ('Coffee', 'Espresso-Based'), ('Coffee', 'Brewed Coffee'), ('Coffee', 'Cold Coffee'), ('Coffee', 'Specialty Coffee'), ('Tea & Infusions', 'True Teas'), ('Tea & Infusions', 'Spiced & Milk Teas'), ('Tea & Infusions', 'Matcha'), ('Tea & Infusions', 'Herbal & Tisanes'), ('Tea & Infusions', 'Bubble / Boba Tea'), ('Tea & Infusions', 'Iced Teas & Coolers'), ('Hot Chocolate & Warm Comforts', 'Classic Cocoa & Drinking Chocolate'), ('Hot Chocolate & Warm Comforts', 'Spiced Hot Chocolate'), ('Hot Chocolate & Warm Comforts', 'Golden Milk & Steamers'), ('Hot Chocolate & Warm Comforts', 'Sahlab & Malted Warmers'), ('Juices, Smoothies & Blends', 'Fresh & Cold-Pressed Juices'), ('Juices, Smoothies & Blends', 'Smoothies'), ('Juices, Smoothies & Blends', 'Milkshakes & Malts'), ('Juices, Smoothies & Blends', 'Protein & Functional Shakes'), ('Milk, Plant Milks & Cultured Drinks', 'Dairy Milks'), ('Milk, Plant Milks & Cultured Drinks', 'Plant Milks'), ('Milk, Plant Milks & Cultured Drinks', 'Yogurt & Cultured Drinks'), ('Sodas, Tonics & Fizz', 'Soft Drinks'), ('Sodas, Tonics & Fizz', 'Craft & Small-Batch Sodas'), ('Sodas, Tonics & Fizz', 'Italian & Flavoured Sodas'), ('Sodas, Tonics & Fizz', 'Tonic Waters & Mixers'), ('Sodas, Tonics & Fizz', 'Ginger Ale & Ginger Beer'), ('Sodas, Tonics & Fizz', 'Lemonades & Limeades'), ('Functional & Fermented', 'Kombucha & Fermented Sodas'), ('Functional & Fermented', 'Switchel & Sekanjabin'), ('Functional & Fermented', 'Energy Drinks'), ('Functional & Fermented', 'Electrolyte & Sports Drinks'), ('Functional & Fermented', 'Wellness Tonics'), ('Beer & Brewing', 'Beer Styles'), ('Beer & Brewing', 'Homebrew'), ('Beer & Brewing', 'Beer Drinks'), ('Wine, Cider & Fermented Fruit', 'Wine'), ('Wine, Cider & Fermented Fruit', 'Fortified Wines'), ('Wine, Cider & Fermented Fruit', 'Cider & Perry'), ('Wine, Cider & Fermented Fruit', 'Mead'), ('Wine, Cider & Fermented Fruit', 'Rice & Grain Wines'), ('Wine, Cider & Fermented Fruit', 'Wine Drinks'), ('Spirits & Liqueurs', 'Base Spirits'), ('Spirits & Liqueurs', 'Liqueurs & Amari'), ('Spirits & Liqueurs', 'Homemade Infusions'), ('Cocktails & Mixed Drinks', 'Sours'), ('Cocktails & Mixed Drinks', 'Highballs & Long Drinks'), ('Cocktails & Mixed Drinks', 'Spirit-Forward & Stirred'), ('Cocktails & Mixed Drinks', 'Bubbles & Spritzes'), ('Cocktails & Mixed Drinks', 'Tiki & Tropical'), ('Cocktails & Mixed Drinks', 'Creamy & Flips'), ('Cocktails & Mixed Drinks', 'Hot Cocktails'), ('Cocktails & Mixed Drinks', 'Frozen & Blended'), ('Cocktails & Mixed Drinks', 'Punches, Batched & RTDs'), ('Syrups & Sweeteners', 'Simple & Demerara Syrups'), ('Syrups & Sweeteners', 'Flavoured Syrups'), ('Syrups & Sweeteners', 'Classic Bar Syrups'), ('Cordials, Squash & Concentrates', 'Fruit Cordials & Squash'), ('Cordials, Squash & Concentrates', 'Agua Fresca & Horchata Concentrates'), ('Cordials, Squash & Concentrates', 'Purées & Sour Mixes'), ('Shrubs, Bitters & Infusions', 'Drinking-Vinegar Shrubs'), ('Shrubs, Bitters & Infusions', 'Homemade Bitters'), ('Shrubs, Bitters & Infusions', 'Tinctures & Botanical Infusions'), ('Garnishes, Ice & Glassware', 'Ice'), ('Garnishes, Ice & Glassware', 'Garnishes'), ('Garnishes, Ice & Glassware', 'Glassware & Tools'), ('Techniques & Reference', 'Mixing Techniques'), ('Techniques & Reference', 'Batching & Scaling'), ('Techniques & Reference', 'Measurements & Conversions'), ('World Drinks', 'The Americas'), ('World Drinks', 'South America (Southern Cone)'), ('World Drinks', 'Europe'), ('World Drinks', 'Africa & Middle East'), ('World Drinks', 'South & Central Asia'), ('World Drinks', 'East & Southeast Asia'), ('By Season & Occasion', 'Summer Coolers'), ('By Season & Occasion', 'Winter Warmers'), ('By Season & Occasion', 'Brunch'), ('By Season & Occasion', 'Celebration & Festive'), ('By Season & Occasion', 'Nightcaps & Wind-Downs'), ('For Kids', 'Fun Mocktails & Fizzes'), ('For Kids', 'Hot Cocoa & Milk Drinks'), ('For Kids', 'Juice Blends, Smoothies & Milkshakes'), ('For Kids', 'Party Punches (Alcohol-Free)'), ('Mocktails & Zero-Proof', 'Craft Mocktails'), ('Mocktails & Zero-Proof', 'Zero-Proof Spirits'), ('Mocktails & Zero-Proof', 'Botanical Elixirs & AF Spritzes'), ('Mocktails & Zero-Proof', 'Alcohol-Free Classics')
  );

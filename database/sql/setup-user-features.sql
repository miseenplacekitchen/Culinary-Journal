...
BEGIN
  ...
  RETURN QUERY
    SELECT sr.id, sr.recipe_name, sr.category, sr.status,
           sr.submitted_at, sr.reviewed_at, sr.reviewer_notes,
           sr.image_url, sr.visibility
...
-- 2. Get approved public recipes (for recipes page)

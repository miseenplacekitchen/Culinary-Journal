-- fix-dish-index-list-filter-csv.sql — Step 4b: Hero Ingredient CSV header alias.
-- Run immediately after fix-dish-index-list-filter.sql. Safe to re-run.
...
SELECT 'fix-dish-index-list-filter-csv complete' AS status;

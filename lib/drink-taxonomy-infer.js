/**
 * Sips & Stories — sub-category inference (J1–J9 via tcj-sips-stories-taxonomy.js).
 * Legacy RULES below are fallback only; divisions come later.
 */
(function (root) {
  'use strict';
  ...
  function infer(blob) {
    ...
    if (typeof inferCategorySubFromBlob === 'function') {
      var canon = inferCategorySubFromBlob('Sips & Stories', text);
      if (canon.sub) return canon;
    }

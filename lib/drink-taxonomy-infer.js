...
(function (root) {
  ...
  var RULES = [
    ...
    /* Legacy */
    { re: /\b(cocktail|spirit|wine|beer)\b/, sub: 'Cocktails & Spirits', div: '' },
    { re: /\b(mocktail)\b/, sub: 'Mocktails', div: '' },
    { re: /\b(smoothie|shake)\b/, sub: 'Smoothies & Shakes', div: '' },
    { re: /\b(tea|coffee)\b/, sub: 'Tea & Coffee', div: '' },
    { re: /\b(juice|lemonade)\b/, sub: 'Juices & Refreshers', div: '' },

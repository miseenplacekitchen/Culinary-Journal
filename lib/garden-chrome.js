...
(function (global) {
  ...
  var TABS = [
    ...
    { id: 'journal', href: 'garden-journal.html', label: 'Journal', emoji: '📓', signedInOnly: true }
  ];
    ...
    root.innerHTML =
      '<div class="lib-hero lib-hero-mise">' +
        '<div class="lib-hero-inner">' +
          ...
          '<p class="lib-hero-desc">Climate-aware growing profiles linked to your kitchen — care cards, seasonal calendars, cultivar picks, and governed ingredient bridges.</p>' +
          searchHtml +
        '</div>' +
      '</div>' +

...
(function (root, factory) {
  ...
  function inferRecipeCategoryFromBlob(name, ingredientLines) {
    if (typeof TcjCategoryInfer !== 'undefined' && TcjCategoryInfer.inferRecipeCategoryFromBlob) {
      return TcjCategoryInfer.inferRecipeCategoryFromBlob(name, ingredientLines);
    }
    ...
    var rules = [
      ...
      { re: /\b(puttu|idiyappam|idli|dosa|appam|waffle|pancake|omelette|porridge|breakfast)\b/, value: 'Curds, Creams & Eggs' },
      { re: /\b(roti|rotti|chapati|paratha|naan|flatbread|bread|loaf|roll|pita|kulcha)\b/, value: 'Breads & Bakery' },
      ...
      { re: /\b(mocktail|cocktail|martini|margarita|mojito|daiquiri|sangria|spritz|negroni|old fashioned|highball|sour|punch|liqueur|spirit|vodka|gin|rum|whiskey|whisky|bourbon|tequila|brandy|wine|beer|cider|prosecco|champagne|mezcal|aperol|campari|bitters|shandy|rtd|hard seltzer)\b/, value: 'Sips & Stories' },
      { re: /\b(water|sparkling water|mineral water|coffee|espresso|latte|cappuccino|matcha|tea|herbal tea|tisane|juice|nectar|smoothie|milkshake|shake|protein shake|protein drink|energy drink|kombucha|kefir|lassi|chaas|kvass|chicha|yerba mate|horchata|sharbat|jallab|bubble tea|boba|tonic|soda|cordial|squash|shrub|agua fresca|lemonade|refresher|hot chocolate|cocoa|drink|beverage|mocktail|electrolyte|sports drink|ginger beer|ginger ale|seedlip|zero.?proof)\b/, value: 'Sips & Stories' },
      { re: /\b(salad|raita|vegetable|sabzi|thoran|aubergine|eggplant|potato)\b/, value: 'Garden & Earth' },
      ...
      { re: /\b(rice|dal|lentil|grain|nasi)\b/, value: 'The Grain Field' }
    ];
    ...
    if (typeof DrinkTaxonomyInfer !== 'undefined' && DrinkTaxonomyInfer.inferCategory) {
      ...
      if (drinkCat && typeof TcjCategoryInfer !== 'undefined' && TcjCategoryInfer.normalizeCategory) {
        return TcjCategoryInfer.normalizeCategory(drinkCat) || drinkCat;
      }

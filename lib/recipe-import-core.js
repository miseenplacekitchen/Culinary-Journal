...
(function (root, factory) {
  ...
  function inferRecipeCategoryFromBlob(name, ingredientLines) {
    ...
    var rules = [
      ...
      { re: /\b(puttu|idiyappam|idli|dosa|appam|waffle|pancake|omelette|porridge|breakfast)\b/, value: 'Rise & Shine' },
      { re: /\b(roti|rotti|chapati|paratha|naan|flatbread|bread|loaf|roll|pita|kulcha)\b/, value: 'Breads & Bakes' },
      ...
      { re: /\b(rice|dal|lentil|grain|nasi)\b/, value: 'Grains & Comfort' }
    ];

...
async function gmLoadCoreData() {
  ...
  var core = {
    ...
    imports: await gmFetchSafe('/rest/v1/garden_import_queue?select=id,source_path,species_name,species_slug,status,variety_count,payload,created_at&order=created_at.desc&limit=40') || []
  };
  _gmCache.core = core;
  return core;
}
...
function gmBuildHealthTab(core) {
  ...
  return gmAccordion('Health checks', healthHtml, true) +
    ...
    gmAccordion('Export pipeline',
      ...
      '<strong>Kitchen profiles:</strong> run <code>fix-phase54-garden-kitchen-profiles.sql</code> for 15 species care + calendar.<br>' +

...
async function loadLibSubmissions(status) {
  ...
  } catch (e) { TcjErr.warn('admin_get_library_submissions', e); }
}
...
async function reviewLibSubmission(id, action, fromModal) {
  ...
  } catch (e) { TcjErr.warn('admin_review_library_submission', e); }
}
...
async function loadLibProfiles(status, imageStatus, resetPage) {
  ...
  try {
    var stats = await rpc('admin_get_library_image_stats', { p_type: LIB_CURRENT_TYPE }).catch(function(e){ return TcjErr.rpcFallback('lib/lm-interface.js', e, null); });
  ...
  } catch (e) { TcjErr.warn('lib/lm-interface.js:221', e); }
}
    ...
    if (btn) {
      ...
      if (action === 'lib-mise-approve' && lid) {
        rpc('admin_set_library_image_status', { p_type: LIB_CURRENT_TYPE, p_id: lid, p_status: 'approved' })
          ...
          .catch(function(e){ TcjErr.warn('lib/lm-interface.js', e); });
      }
...
async function libIngAutocomplete(profileId, query) {
  ...
  } catch (_) { TcjErr.warn('lib/lm-interface.js:464', _); }
}
...
async function libRefreshGovernedPreview(profileId) {
  ...
  } catch(_) { TcjErr.warn('lib/lm-interface.js', _); }
}
...
async function libBulkAction(action, value) {
  ...
  try {
    ...
    loadLibProfiles(undefined, undefined, false);
  } catch (e) { TcjErr.warn('lib/lm-interface.js:505', e); }
}
...
async function loadLmInterface() {
  ...
  } catch (_) { TcjErr.warn('lib/lm-interface.js:565', _); }
...
async function lmLoadProfileById(id, type) {
  ...
  } catch (e) { TcjErr.warn('lib/lm-interface.js:929', e); }
}
...
async function lmPreviewHeroImage(input) {
  ...
  } catch (_) { TcjErr.warn('lib/lm-interface.js:985', _); }
  input.value = '';
}
...
async function saveLibEditor() {
  ...
  } catch (e) { TcjErr.warn('lib/lm-interface.js:1092', e); }
  }
}
...
async function importLibCsv() {
  ...
  } catch (e) { TcjErr.warn('lib/lm-interface.js:1178', e); }
}
...
async function loadLibCoverage() {
  ...
  } catch (e) { TcjErr.warn('admin_get_library_coverage', e); }
}

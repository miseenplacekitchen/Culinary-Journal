/**
 * Recipe sub-category helpers (infer rules only — browse/admin load taxonomy from DB RPC).
 */
...
var SUB_TAXONOMY_INFER_ALIASES = {
  ...
  'Feather & Flock': [
    ...
    [/\b(chicken liver|duck gizzard|turkey heart|giblet|foie gras|chicken feet|cockscomb)\b/i, 'Poultry Offal & Internal Treasures']
  ],
  'Pasture & Hoof': [
    ...
    [/\b(oxtail|sweetbread|tripe|kidney|bone marrow|pork blood|black pudding|trotter|offal|liver)\b/i, 'Variety Meats, Blood & Land Offal']
  ],
  'Ocean & River': [

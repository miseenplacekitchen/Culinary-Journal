...
(function (global) {
  ...
  var TCJ_LIB_TYPE_META = {
    ingredient: {
      ...
      chefs: 'Betty reaches for waxy potatoes in salads and floury ones for mash — the starch type matters more than the brand.',
    ...
    cut: {
      ...
      chefs: 'Brisket wants low heat and time — rushing it is the mistake Betty sees most often at home.',
    ...
    preservation: {
      ...
      chefs: 'Acidity and processing time are not negotiable — Betty treats published times as law, not suggestion.',
      brand: 'n/a',

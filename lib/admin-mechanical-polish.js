...
const CATEGORY_RULES = [
  ...
  [/\b(puttu|idiyappam|idli|dosa|appam|waffle|pancake|omelette|porridge|breakfast)\b/i, 'Rise & Shine'],
  [/\b(roti|chapati|paratha|naan|flatbread|bread|loaf|roll|pita|kulcha)\b/i, 'Breads & Bakes'],
  ...
  [/\b(chicken|mutton|lamb|beef|pork|meat|steak|bacon|sausage)\b/i, 'Meat & Fire'],
  [/\b(rice|nasi|dal|lentil|grain)\b/i, 'Grains & Comfort'],
];

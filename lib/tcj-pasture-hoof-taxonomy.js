/**
 * Pasture & Hoof — protein-led sub-categories (C1–C8, 2026).
...
var TCJ_PASTURE_TAXONOMY = [
  {
    ...
    shortName: 'Beef & Veal',
    emoji: '🐂',
    ingredients: ['Bone-In Ribs', 'Shanks', 'Brisket', 'Steaks', 'Minced Beef', 'Veal Cutlets'],
  ...
  {
    code: 'C8',
    name: 'Variety Meats, Blood & Land Offal',
    shortName: 'Land Offal',
    emoji: '🫁',
    ingredients: ['Beef Liver', 'Pork Tripe', 'Oxtail', 'Sweetbreads', 'Kidneys', 'Pork Blood', 'Lamb Tongue', 'Bone Marrow', 'Pig Trotters'],
